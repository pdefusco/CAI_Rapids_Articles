...
G = cugraph.Graph()
G.from_cudf_edgelist(edgelist_df, source='src', destination='dst')

# Define personalization values for specific vertices
personalization = {0: 0.5, 2: 0.3} # Higher values indicate higher preference

# Compute personalized PageRank
pr = cugraph.pagerank(G, personalization=personalization)
